    ...
    messages: [
      {
        ...
        senderRole: "client",
        message: "Feeling strong today! Completed all workouts this week. Sleep has been great.",
      ...
      },
      {
        ...
        senderRole: "coach",
        message: "Excellent work, Sarah! Your consistency is paying off. Keep up the great sleep routine.",
    ...
    messages: [
      {
        ...
        senderName: "Sarah Chen",
        senderRole: "client",
        message: "Good energy levels. Hit a new PR on my 5K run - 22:45!",
      ...
      },
      {
        ...
        senderName: "Dr. Alex Rivera",
        senderRole: "coach",
        message: "That's a fantastic PR! Your training is clearly working. Let's maintain this momentum.",
      ...
      },
      {
        ...
        senderName: "Sarah Chen",
        senderRole: "client",
        message: "Thanks! Should I increase the intensity for next week or keep it steady?",
    ...
    messages: [
      {
        ...
        senderName: "Sarah Chen",
        senderRole: "client",
        message: "Great week overall! All workouts completed. Nutrition has been on point. Feeling ready for next week's challenges.",
    ...
    messages: [
      {
        ...
        senderRole: "client",
        message: "Struggled with sleep again last night. Only got 5 hours. Feeling exhausted and stressed from work deadlines.",
    ...
    messages: [
      {
        ...
        senderName: "Marcus Johnson",
        senderRole: "client",
        message: "Tried the breathing exercises you recommended. Helped a bit with stress. Still having trouble winding down at night.",
      ...
      },
      {
        ...
        senderName: "Dr. Alex Rivera",
        senderRole: "coach",
        message: "I'm glad the breathing exercises are helping. Let's adjust your evening routine - I'll send you a modified plan that includes more recovery time before bed.",
        timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
        read: true,
      },
    ],
